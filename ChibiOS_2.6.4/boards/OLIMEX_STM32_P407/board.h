 ...
 * PA13 - GPIOA_JTMS            (alternate 0, pull-up).
 * PA14 - GPIOA_JTCK            (alternate 0, pull-down).
 ...
 * PB2  - GPIOB_CAM_ENB         (on oublie).
 * PB3  - GPIOB_JTDO            (alternate 0, pull-up).
 * PB4  - GPIOB_NJTRST          (alternate 0, floating).
...
#define VAL_GPIOB_MODER     (PIN_MODE_OUTPUT(GPIOB_LCD_BL) |                \
                             ...
                             PIN_MODE_ALTERNATE(GPIOB_CAM_ENB) |            \
